...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['owner', 'administrator', 'team-member'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Airdrop', path: '/airdrops', entity: 'airdrop', service: AccessServiceEnum.PROJECT, icon: FiGift },
    { name: 'Reward', path: '/rewards', entity: 'reward', service: AccessServiceEnum.PROJECT, icon: FiAward },
